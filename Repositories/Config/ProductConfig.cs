    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 8, CategoryId=1, ImageUrl="/images/8.jpg", ProductName = "Xp-Pen", Price = 450 ,ShowCase=true},
                 new Product() { ProductId = 9, CategoryId = 1, ImageUrl = "/images/9.jpg", ProductName = "Samsung Galaxay F5", Price = 4540 ,ShowCase=true},
                  new Product() { ProductId = 10, CategoryId = 2, ImageUrl = "/images/10.jpg", ProductName = "Hp Mouse", Price = 457 ,ShowCase=true}
            );
        }
    }
}